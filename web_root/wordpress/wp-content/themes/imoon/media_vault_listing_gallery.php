<?php
/*
Template Name: Media Vault Listings - Gallery 
*/
?>
...
<div id="media_list_2col">
		...
		<?php if (have_posts()):
		$posts = get_posts('cat=9&numberposts=200');
		...
		<div class="media_list_box_2col">
			...
			<div class="media_list_textinfo">			
				...
				<!-- Get Permalink for CTA Button --> 		
					<div class="galplay" ><a href="<?php the_permalink()?>" title="Play Video"></a></div>
